...
<div class="container mt-4">
    ...
    <form action="/rule/edit/<?= urlencode($ruleData['ruleID'] ?? '') ?>" method="POST" id="ruleForm">
        <!-- Rule Title -->
        <div class="mb-3">
        ...
        <!-- Associated Election Event (same dropdown UX as createRule.php) -->
        <div class="mb-3">
            ...
            <!-- Hidden field to submit the selected electionID -->
            <input type="hidden"
                   name="electionID"
                   id="electionID"
                   value="<?= htmlspecialchars($ruleData['electionID'] ?? '') ?>">
